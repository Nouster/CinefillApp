...
@Published var eventsPreviewArray = [
    ...
    Events(eventsName: "Cinéma sous les étoiles: Le Roi Lion", eventsPictures: "souslesétoilesleroilion", eventsDescription: "Pour cette première séance de Ciné sous les étoiles, découvrez en famille le film **Le roi lion,** un film de Jon Favreau. Pour les grands et les petits, cet évènement sera marqué par la présence des acteurs ayant prêtés leur voix aux personnages de l'un des plus grands chefs d'oeuvres de l'histoire de l'animation. Profitez de toute la technologie de l'audio-visuel en plein air.", eventsDateStart: "12/07/2022", eventsDateEnd: "12/07/2022", eventsLocation: "Toulouse",enventsAdress: "Parc Duroch - Rue Gilet, 31770 Colomiers 31770 Colomiers", eventsCategorie: "Projection"),
